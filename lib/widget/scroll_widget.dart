...
class ScrollWidgetRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    list.add(RouteBean("scroll_controller_page", "ScrollController"));
    list.add(RouteBean("notification_listener_page", "NotificationListener"));
...
class ScrollControllerRoute extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ScrollControllerRouteState();
}
...
class NotificationListenerRoute extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => NotificationListenerRouteState();
}

class NotificationListenerRouteState extends State<NotificationListenerRoute> {
  String _progress = "0%";
